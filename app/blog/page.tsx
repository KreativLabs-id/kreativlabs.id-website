          ...
          <AnimatedSection animation="fade-up">
            <div className="text-center max-w-3xl mx-auto">
              <div className="inline-flex items-center gap-2 px-4 py-2 bg-[#3B82F6]/10 border border-[#3B82F6]/20 rounded-full mb-6 backdrop-blur-sm">
                ...
                <span className="text-sm text-white/90 font-medium">Blog & Artikel</span>
              </div>
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-6">
                Blog <span className="text-[#3B82F6]">Kreativ Labs</span>
              </h1>
        ...
        <div className="container mx-auto px-6">
          ...
          {blogPosts.length === 0 && (
            <div className="text-center py-20">
              <p className="text-white/60 text-lg">Belum ada artikel yang dipublikasikan.</p>
            </div>
          )}
