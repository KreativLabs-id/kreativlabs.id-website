    ...
    <main className="min-h-screen bg-background overflow-x-hidden w-full max-w-[100vw]">
      ...
      <section className="py-8 bg-background">
        <div className="container mx-auto px-6">
          <div className="max-w-4xl mx-auto">
            <AnimatedSection animation="fade-up">
              <div className="bg-gradient-to-br from-card to-[#1E3A5F] border border-primary/30 rounded-2xl p-8 mb-8">
              ...
              {cookieTypes.map((cookie, index) => {
                ...
                return (
                  <AnimatedSection key={index} animation="fade-up" delay={index * 100}>
                    <div className="bg-card border border-foreground/10 rounded-2xl p-8 hover:border-primary/30 transition-all duration-300">
                      {/* Header */}
                      ...
                      <div className="ml-16 space-y-4">
                        <div>
                          <h4 className="text-foreground/90 font-semibold mb-2 text-sm">Contoh Penggunaan:</h4>
              ...
              <div className="bg-card border border-foreground/10 rounded-2xl p-8">
                ...
                <div className="space-y-4">
                  {thirdPartyCookies.map((service, index) => (
                    <div key={index} className="bg-foreground/5 rounded-xl p-4 hover:bg-foreground/10 transition-colors">
                      <div className="flex items-start justify-between gap-4">
                        <div>
                          <h4 className="text-foreground font-semibold mb-1">{service.name}</h4>
                          <p className="text-foreground/70 text-sm">{service.purpose}</p>
                        </div>
                        <a 
                          href={service.link}
                          target="_blank"
                          rel="noopener noreferrer"
                          className="text-primary hover:text-primary/80 text-sm whitespace-nowrap transition-colors"
                        >
                          Privacy Policy →
                        </a>
                      </div>
      ...
      <section className="py-8 bg-background">
        <div className="container mx-auto px-6">
          <div className="max-w-4xl mx-auto">
            <AnimatedSection animation="fade-up">
              <div className="bg-gradient-to-br from-card to-[#1E3A5F] border border-primary/30 rounded-2xl p-8">
                <div className="flex items-start gap-4 mb-6">
                ...
                <div className="ml-16 space-y-4 text-foreground/80 leading-relaxed">
                  <div>
                    <h4 className="text-foreground font-semibold mb-2">Pengaturan Browser:</h4>
                    <p className="mb-3">
                  ...
                  <div className="pt-4 border-t border-foreground/10">
                    <p className="text-foreground/70 text-sm">
                      <strong className="text-foreground">Catatan:</strong> Menonaktifkan cookie tertentu dapat mempengaruhi fungsionalitas website dan pengalaman browsing Anda.
                    </p>
                  </div>
                </div>
              </div>
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <AnimatedSection animation="fade-up" delay={100}>
              <div className="text-center pt-8">
                ...
                <Link 
                  href="/#contact"
                  className="inline-flex items-center gap-2 px-8 py-4 bg-primary hover:bg-primary/90 text-primary-foreground font-semibold rounded-full transition-all duration-300 shadow-lg shadow-primary/30"
                >
