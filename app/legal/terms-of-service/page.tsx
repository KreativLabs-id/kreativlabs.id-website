  ...
  return (
    <main className="min-h-screen bg-background overflow-x-hidden w-full max-w-[100vw]">
      ...
      <section className="relative pt-32 pb-16 bg-gradient-to-b from-background to-card">
        <div className="absolute top-20 left-10 w-96 h-96 bg-primary rounded-full blur-[120px] opacity-10"></div>
                  ...
                  <div className="bg-card border border-foreground/10 rounded-2xl p-8 hover:border-primary/30 transition-all duration-300">
                    ...
                    <ul className="space-y-3 ml-16">
                      {section.content.map((item, idx) => (
                        <li key={idx} className="flex items-start gap-3 text-foreground/80 text-base leading-relaxed">
