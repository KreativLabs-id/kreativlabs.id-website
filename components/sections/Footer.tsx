...
import { Instagram, Mail, Twitter, Facebook, Globe, ArrowRight, Linkedin } from "lucide-react";
...
const socialLinks = [
  ...
  {
    icon: ThreadsIcon,
    href: "https://www.threads.net/@kreativlabs.id",
    label: "Threads",
  },
  {
    icon: Linkedin,
    href: "https://www.linkedin.com/company/kreativlabs-id/",
    label: "LinkedIn",
  },
  {
    icon: Twitter,
