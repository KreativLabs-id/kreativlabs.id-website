  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (response.ok) {
        setSubmitStatus({
          type: "success",
          message: "Pesan berhasil dikirim! Tim KreativLabs akan segera menghubungi Anda.",
        });
        ...
        if (emailJsServiceId && emailJsTemplateId && emailJsPublicKey) {
          await emailjs.send(
            ...
            emailJsTemplateId,
            {
              ...
              message: `[Layanan: ${formData.service}] ${formData.message}`,
      ...
      setSubmitStatus({
        type: "error",
        message: "Gagal mengirim pesan. Silakan hubungi kami langsung via WhatsApp.",
      });
    } finally {
        ...
        <AnimatedSection animation="fade-up">
          <div className="text-center mb-12">
            <h2 className="text-3xl sm:text-4xl font-bold text-foreground mb-3 tracking-tight">
              Mulai Konsultasi <span className="text-primary">Project Anda</span>
            </h2>
            <p className="text-foreground/70 text-sm sm:text-base max-w-xl mx-auto leading-relaxed">
              Ceritakan ide website atau kebutuhan desain bisnis Anda. Tim kami siap membantu memberikan solusi teknis dan estimasi jadwal yang akurat.
            </p>
          </div>
        </AnimatedSection>
              ...
              <div className="space-y-6">
                <div>
                  ...
                  <p className="text-xs sm:text-sm text-foreground/70 leading-relaxed">
                    Hubungi kami melalui saluran resmi atau kirim pesan singkat melalui formulir di samping.
                  </p>
                </div>
                ...
                <div className="space-y-4 pt-2">
                  ...
                  <div className="flex items-start gap-3.5">
                    ...
                    <div>
                      <div className="text-xs text-foreground/60 font-medium">Email Kantor</div>
                      <a
                  ...
                  <div className="flex items-start gap-3.5">
                    ...
                    <div>
                      <div className="text-xs text-foreground/60 font-medium">Lokasi Studio</div>
                  ...
                  <div className="flex items-start gap-3.5">
                    ...
                    <div>
                      <div className="text-xs text-foreground/60 font-medium">Jam Konsultasi</div>
            ...
            <div className="lg:col-span-7 bg-card border border-border/80 rounded-3xl p-6 sm:p-8 md:p-9 shadow-xs">
              <form onSubmit={handleSubmit} className="space-y-4 sm:space-y-5">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    <Input
                      ...
                      name="email"
                      type="text"
                      placeholder="email@bisnis.com atau 0812..."
                ...
                <div>
                  ...
                  >
                    <option value="website">Pembuatan Website (Landing Page / Profil)</option>
                    <option value="custom-app">Website Kustom / Aplikasi Web (POS, Portal)</option>
                    <option value="branding">Desain Logo & Identitas Brand</option>
                    <option value="social-media">Desain Konten & Social Media Kit</option>
                    <option value="uiux">Desain UI/UX (Figma Web & Mobile)</option>
                ...
                <div>
                  ...
                  <Textarea
                    id="message"
                    name="message"
                    placeholder="Ceritakan gambaran website atau desain yang ingin Anda buat..."
