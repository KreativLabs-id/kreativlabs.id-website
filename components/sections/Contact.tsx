...
const contactInfo = [
  {
    ...
    link: "https://wa.me/6285872381791?text=Halo%20KreativLabs,%20saya%20ingin%20konsultasi%20project",
  },
  {
    icon: Mail,
    title: "Email",
        ...
        <AnimatedSection animation="fade-up">
          <div className="text-center mb-12">
            ...
            <p className="text-foreground/70 text-sm sm:text-base max-w-xl mx-auto leading-relaxed">
              Ceritakan ide website atau kebutuhan desain bisnis Anda. Tim kami siap membantu memberikan solusi dan estimasi terbaik.
            </p>
          </div>
        </AnimatedSection>
            ...
            <div className="lg:col-span-4 space-y-4">
              ...
              <div className="bg-primary/5 border border-primary/20 rounded-2xl p-5">
                <p className="text-xs text-foreground/80 leading-relaxed mb-3">
                  Butuh respon cepat? Hubungi kami langsung melalui chat WhatsApp untuk diskusi jadwal & harga.
                </p>
                <a
