    ...
    return (
      ...
      >
        ...
        >
          ...
          {/* Animated gradient paths - animating natively inside defs */}
            ...
            {allPaths.map((_, index) => {
              ...
              return (
                ...
                >
                  ...
                  <stop offset="32.5%" stopColor="#3B82F6" />
                  <stop offset="100%" stopColor="#93C5FD" stopOpacity="0" />

                  {/* Native SVG animations! Replaces framer-motion Context bottleneck */}
